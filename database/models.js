...
db.sync({ force: true }).then(() => {
  ...
  Item.create({
    item_name: 'Hamburger', item_price: 5.50, item_image: 'https://www.rallys.com/wp-content/uploads/2017/03/BigBuford_Feature_1000x1000-600x600.jpg', item_ingredients: '[{ingredient_id: 1, ingredient_amount: 0.2}, {ingredient_id: 2, ingredient_amount: 0.3}, {ingredient_id: 3, ingredient_amount: 0.4}, {ingredient_id: 4, ingredient_amount: 0.1}, {ingredient_id: 5, ingredient_amount: 0.34}, {ingredient_id: 6, ingredient_amount: 0.21}]', item_category: 2,
  });
  Item.create({
    item_name: 'Coca-Cola', item_price: 1, item_image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQY2B_5VgeOlPdpGZLz3H4SBmazfFS1gsoxtcBddF0awQux3EiY', item_ingredients: '[{ingredient_id: 7, ingredient_amount: 0.5}]', item_category: 1,
  });
  Item.create({
    item_name: 'Basic Salad', item_price: 6, item_image: 'https://recipes.heart.org/-/media/aha/recipe/recipe-images/mediterranean-salad.jpg', item_ingredients: '[{ingredient_id: 2, ingredient_amount: 0.25}, {ingredient_id: 3, ingredient_amount: 0.15}, {ingredient_id: 4, ingredient_amount: 0.32}]', item_category: 3,
  });
  Item.create({
    item_name: 'Chicken Noodle Soup', item_price: 4, item_ingredients: '[{ingredient_id: 6, ingredient_amount: 0.3}]', item_category: 4,
  });
  Item.create({
    item_name: 'Egg and Cheese Sandwich', item_price: 3, item_ingredients: '[{ingredient_id: 6, ingredient_amount: 0.25}]', item_category: 6,
  });
  Order.create({
